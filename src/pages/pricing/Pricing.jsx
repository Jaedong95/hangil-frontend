...
export default function Pricing() {
  ...
  return (
    <div>
      <PageHeader
        title="대가 산정"
        subtitle="정보시스템 감리 대가 산정 기준과 계산기를 제공합니다."
      ...
      <section className="page-section">
        <div className="container">
          ...
          <div style={{ marginTop: 56 }}>
            ...
            <p className="section-subtitle">감리 유형에 따라 계수를 달리 적용하며, 난이도 요인을 반영하여 최종 기본감리비를 산정합니다.</p>
          ...
          <div style={{ marginTop: 48 }}>
            <h3 className="pricing-section-title">감리대상사업비 보정비율</h3>
            <p className="pricing-section-sub">※ 감리대상사업비에서 부가가치세를 제외한 금액(또는 추정가격)에 아래 보정비율을 곱하여 보정금액을 산정합니다.</p>
          ...
          <div style={{ marginTop: 40 }}>
            <h3 className="pricing-section-title">난이도 요인 및 계수</h3>
            <div style={{ overflowX: 'auto' }}>
              <table className="pricing-table">
                <thead>
          ...
          <div style={{ marginTop: 60 }}>
            <div className="section-divider" />
            <h2 className="section-title">감리 대가 산정 계산기</h2>
            <p className="section-subtitle">
              감리대상사업비 구성항목별 금액을 입력하면 기본감리비를 자동으로 산출합니다.
              상주 및 추가감리비, 직접경비는 별도 산정이 필요합니다.
            </p>
