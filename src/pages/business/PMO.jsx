...
const PMO_STEPS = [
  ...
  },
  {
    ...
    title: '일정·비용 통합 관리',
    sub: '숫자로 증명하는 투명한 관리',
    desc: 'WBS 기반 일정 추적과 예산 집행 현황 모니터링을 병행합니다. FP Code 솔루션을 활용한 기능점수 기반 객관적 비용 산정으로 예산 왜곡과 범위 초과을 방지합니다.',
  },
  {
    num: '03',
    title: '품질·리스크 관리',
...
const BENEFITS = [
  ...
  },
  {
    icon: '🚀',
    title: '납기 및 예산 준수',
    desc: 'AI 기반 리스크 사전 진단과 FP Code 솔루션으로 납기와 예산 준수율을 체계적으로 높입니다.',
  },
];
        ...
        <div className="container">
          ...
          <div className="ism-about">
            ...
            <p className="biz-page-desc">
              ...
              AI 기술로 리스크를 선제적으로 진단하고 자체 개발한 <strong>FP Code 솔루션</strong>으로
              기능점수 산정의 객관성을 확보합니다.
